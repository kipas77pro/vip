...
# --- Pilihan Domain ---
echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ \033[1;37mPilih 1 & Masukin Domain Kalian${BIBlue}│${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
until [[ $domain =~ ^1$ ]]; do
...
res1() {
    ...
    wget https://raw.githubusercontent.com/kipas77pro/vip/refs/heads/main/SYSTEM/ssh-vpn.sh -O ssh-vpn.sh >/dev/null 2>&1
    chmod +x ssh-vpn.sh
    ./ssh-vpn.sh
...
res2() {
    ...
    wget https://raw.githubusercontent.com/kipas77pro/vip/refs/heads/main/SYSTEM/ins-xray.sh -O ins-xray.sh >/dev/null 2>&1
    chmod +x ins-xray.sh
    ./ins-xray.sh
    clear
}
...
res3() {
    ...
    wget https://raw.githubusercontent.com/kipas77pro/vip/refs/heads/main/WEBSOCKET/insshws.sh -O insshws.sh >/dev/null 2>&1
    chmod +x insshws.sh
    ./insshws.sh
    clear
}
...
res4() {
    ...
    wget https://raw.githubusercontent.com/kipas77pro/vip/refs/heads/main/SYSTEM/set-br.sh -O set-br.sh >/dev/null 2>&1
    chmod +x set-br.sh
    ./set-br.sh
    clear
}
...
res6() {
    ...
    wget https://raw.githubusercontent.com/kipas77pro/vip/refs/heads/main/SYSTEM/udp-custom.sh -O udp-custom.sh >/dev/null 2>&1
...
serverV=$( curl -sS https://raw.githubusercontent.com/kipas77pro/vip/refs/heads/main/TOOLS/versi )
