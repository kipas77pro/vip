...
function domain() {
    ...
    install_slowdns() {
        local script_url="https://raw.githubusercontent.com/kipas77pro/vip/refs/heads/main/SLOWDNS/installsl.sh"
...
10 |10) clear ; wget -q https://raw.githubusercontent.com/kipas77pro/vip/refs/heads/main/rebuildpepesmenu && bash rebuildpepesmenu ;; 
00 |0) clear ; menu ;; 
