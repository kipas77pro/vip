#!/bin/bash
REPO="https://raw.githubusercontent.com/kipas77pro/vip/heads/main/"
...
cd
wget -q -O /usr/bin/limit-ip "https://raw.githubusercontent.com/kipas77pro/vip/refs/heads/main/SYSTEM/limit-ip"
chmod +x /usr/bin/*
cd /usr/bin
sed -i 's/\r//' limit-ip
cd
